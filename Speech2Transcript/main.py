...
def main():
    ...
    # Add template path options
    format_group.add_argument("--telehealth_template", default=None, help="Path to a custom telehealth note template")
    format_group.add_argument("--ccm_template", default=None, help="Path to a custom CCM note template")
    format_group.add_argument("--transcript_file", default=None, help="Path to a transcript file for processing")
